...
+(NSMutableArray*)injuries{
    ...
    dispatch_once(&onceToken, ^{
        ...
        injuryOne.picture = [UIImage imageNamed:@"ankleSprain.jpg"];
        ...
        injuryTwo.longDescription = @"A groin pull is an injury to the adductor muscles called a muscle strain. When a muscle is strained, the muscle is stretched too far. Less severe strains pull the muscle beyond their normal excursion. More severe strains tear the muscle fibers, and can even cause a complete tear of the muscle. Most commonly, groin pulls are minor tears of some muscle fibers, but the bulk of the muscle tissue remains intact.";
        injuryTwo.picture = [UIImage imageNamed:@"pulledGroin.jpg"];
        ...
        injuryThree.picture = [UIImage imageNamed:@"shinSplints.jpg"];
        ...
        injuryFive.name = @"Tennis elbow";
        injuryFive.shortDescription = @"A condition caused by overuse of arm, forearm, and hand muscles that results in elbow pain.";
        injuryFive.longDescription = @"Tennis elbow is caused by either abrupt or subtle injury of the muscle and tendon area around the outside of the elbow. Tennis elbow specifically involves the area where the muscles and tendons of the forearm attach to the outside bony area (called the lateral epicondyle) of the elbow.  Pain slowly increasing around the outside of the elbow. Less often, pain may develop suddenly. Pain is worse when shaking hands or squeezing objects.";
        injuryFive.picture = [UIImage imageNamed:@"tennisElbow.jpg"];
